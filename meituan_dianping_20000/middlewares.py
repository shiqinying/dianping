...
class MeituanDianping20000SpiderMiddleware(object):
...
class MeituanDianping20000DownloaderMiddleware(object):
    # Not all methods need to be defined. If a method is not defined,
...
class ProxyMiddleware(object):
    def __init__(self,settings):
        ABU_YUN_PROXY_URI = 'ABU_YUN_PROXY_URI'+str(random.randint(1,5))
        self.proxy_uri = settings.get('ABU_YUN_PROXY_URI',None)
